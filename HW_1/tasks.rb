...
p arr
puts "------------------------------------------------------------------"
puts "54. Дан целочисленный массив. Преобразовать его, прибавив к четным числам первый элемент. 
Первый и последний элементы массива не изменять.	"
p arr = [127, 96, 127, 27, 32, 32, 45, 127, 3, 32, 3]
  p (arr.map { |e| e != arr[0] && e != arr[-1] && e.even? ? e + arr[0] : e })
puts "------------------------------------------------------------------"
puts "55. Дан целочисленный массив. Преобразовать его, прибавив к четным числам последний элемент. П
ервый и последний элементы массива не изменять."
p arr = [127, 96, 127, 27, 32, 32, 45, 127, 3, 32, 3]
  (arr.map { |e| e != arr[0] && e != arr[-1] && e.even? ? e + arr[-1] : e })
puts "------------------------------------------------------------------"
puts "56. Дан целочисленный массив. Найти максимальный из его локальных максимумов."
p arr = [127, 96, 136, 27, 32, 32, 45, 152, 3, 32, 3]
  maxi = []
    arr.each_cons(3) { |a, b, c| maxi << b if a < b && b > c }
  p  maxi.max
puts "------------------------------------------------------------------"
puts "57. Дан целочисленный массив. Найти минимальный из его локальных минимумов."
p arr = [127, 96, 136, 1, 32, 31, 45, 152, 3, 32, 3]
  mini = []
    arr.each_cons(3) { |a, b, c| mini << b if a > b && b < c }
  p mini.min
puts "------------------------------------------------------------------"
puts "58 Дан целочисленный массив. Вывести индексы элементов, которые меньше своего 
правого соседа, и количество таких чисел."
p arr = [127, -96, 136, -1, 32, 31, -45, 152, 3, -32, 3]
  p indexel = (0...arr.size - 1).select { |e| arr[e] > arr[e + 1] }
p indexel.size
puts "------------------------------------------------------------------"
puts "59 Дан целочисленный массив. Вывести индексы элементов, которые 
больше своего правого соседа, и количество таких чисел."
p arr = [127, -96, 136, -1, 32, 31, -45, 152, 3, -32, 3]
  p indexel_1 = (0...arr.size - 1).select { |e| arr[e] < arr[e + 1] }
p indexel_1.size
puts "------------------------------------------------------------------"
puts "60 Дан целочисленный массив. Вывести индексы элементов, которые меньше 
своего левого соседа, и количество таких чисел.	"
p arr = [127, -96, 136, -1, 32, 31, -45, 152, 3, -32, 3]
  p indexel = (1...arr.size).select { |e| arr[e] < arr[e - 1] }
p indexel.size
puts "------------------------------------------------------------------"